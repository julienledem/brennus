...
//              .exec().call("println").param().literal("sign() => -1").endParam().endCall().endExec()
          ...
          .startMethod(PUBLIC, BOOLEAN, "not").param(BOOLEAN, "b")
            .exec().call("println").get("b").endCall().endExec()
            .exec().call("println").get("b").not().endCall().endExec()
          ...
          .startMethod(PUBLIC, OBJECT, "get").param(INT, "i")
            .switchOn().get("i").endSwitchOn()
              .caseBlock(0)
                .exec().call("println").literal("get(0)").endCall().endExec()
                .returnExp().callNoParam("getFoo").endReturn()
              .endCase()
              .caseBlock(1)
                .exec().call("println").literal("get(1)").endCall().endExec()
                .returnExp().callNoParam("getBar").endReturn()
              .endCase()
              .defaultCase()
          ...
          .startMethod(PUBLIC, VOID, "set").param(INT, "i").param(OBJECT, "o")
            .switchOn().get("i").endSwitchOn()
              .caseBlock(0)
                .exec().call("println").literal("set(0)").endCall().endExec()
                .set("foo").get("o").endSet()
              .breakCase()
              .caseBlock(1)
                .exec().call("println").literal("set(1)").endCall().endExec()
                .exec().call("println").get("o").endCall().endExec()
