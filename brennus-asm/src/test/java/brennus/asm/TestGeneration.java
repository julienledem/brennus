...
//              .exec().call("println").param().literal("sign() => -1").endParam().endCall().endExec()
          ...
          .startMethod(PUBLIC, OBJECT, "get").param(INT, "i")
            .switchOn().get("i").endSwitchOn()
              .caseBlock(0)
                .exec().thisCall("println").literal("get(0)").endCall().endExec()
                .returnExp().thisCallNoParam("getFoo").endReturn()
              .endCase()
              .caseBlock(1)
                .exec().thisCall("println").literal("get(1)").endCall().endExec()
                .returnExp().thisCallNoParam("getBar").endReturn()
              .endCase()
              .defaultCase()
                .exec().thisCall("println").literal("get(?)").endCall().endExec()
                .throwExp().thisCallNoParam("error").endThrow()
              .endCase()
            .endSwitch()
          .endMethod()
          ...
          .startMethod(PUBLIC, VOID, "set").param(INT, "i").param(OBJECT, "o")
            .switchOn().get("i").endSwitchOn()
              .caseBlock(0)
                .exec().thisCall("println").literal("set(0)").endCall().endExec()
                .set("foo").get("o").endSet()
              .breakCase()
              .caseBlock(1)
                .exec().thisCall("println").literal("set(1)").endCall().endExec()
                .exec().thisCall("println").get("o").endCall().endExec()
                .set("bar").get("o").endSet()
              .breakCase()
              .defaultCase()
                .exec().thisCall("println").literal("set(?)").endCall().endExec()
                .throwExp().thisCallNoParam("error").endThrow()
              .breakCase()
            .endSwitch()
          .endMethod()
